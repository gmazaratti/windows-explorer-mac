...
enum Demo {
    ...
    static func run(into directory: String) {
        ...
        guard let ex = AppState.shared.active else { return }
        ...
        let steps: [Step] = [
            ...
            Step(name: "tiles", action: { prefs.viewMode = .tiles }, hold: 1.3),
            ...
            Step(name: "accent", action: { settings.accentID = "green" }, hold: 1.4),
            Step(name: "light", action: { settings.theme = .light }, hold: 1.8),
